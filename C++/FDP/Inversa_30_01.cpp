...
int main(){
    ...
    long double x[10][10], identidad[10][10], filatemp[10];
    ...
    for(i = 1; i <= cx; i++){ // Empiezo a obtener la matriz inversa /////////////////////////////////////
        ...
        if(x[i][i] != 1){ //Esto verifica que el pivote (las diagonales de la matriz) sea igual a 1, si no lo es, lo convierte a 1
            ...
            if(x[i][i] == 0 && i != lx){
                ...
                cout << "0 encontrado en el pivote, reordenando . . ." << endl;
                ...
                for(j = i + 1; j <= lx; ++j){
                    ...
                    if(found){
                        ...
                        cout << "Fila "<<i<< "Interambiada con fila"<<j<< endl;
                        mostrar(x, cx, lx, "Resultado: ");
                        break;

                    }

                    else{
                        cout << "Fila valida no encontrada, Mostrando resultados . . ." << endl;

                        mostrar(x, cx, lx, "Matriz base: ");
                        mostrar(identidad, cx, lx, "Matriz identidad: ");

                        cout << endl << "Esto ocurrio en la iteracion numero: "<<i<<endl;
                        system("pause");
                        return 0;
                    }
                }
