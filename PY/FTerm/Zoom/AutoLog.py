...
class AutoLogger:
    ...
    def log(self, max_delta=2):
        ...
        lesson_command = f'explorer "{AutoLogger.lesson_id_prefix}{lesson_id}{AutoLogger.lesson_pw_prefix}{lesson_pw}"'
        ...
        Logger.animated_course_log('Saliendo', time.sleep, 5)
